...
public record CustomTraderConfig : IConfig
{
    ...
    //public TraderLocaleEntry Locale { get; set; } = new();
    public List<LoyaltyLevelEntry> LoyaltyLevels { get; set; } = [];
}

public record LoyaltyLevelEntry
{
    public int    MinLevel          { get; set; } = 1;
    public double MinStanding       { get; set; } = 0;
    public int    MinSalesSum       { get; set; } = 0;
    public int    BuyPriceCoef      { get; set; } = 0;
    public int    RepairPriceCoef   { get; set; } = 0;
    public int    InsurancePriceCoef { get; set; } = 0;
}
